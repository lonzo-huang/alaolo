...
export function SubNav({ locale }) {
  ...
  const flatLinks = [
    ...
    { key: 'tutorials', label: t('subKnowledgeTutorials'), href: `/${locale}?cat=knowledge&sub=Tutorial` },
    { key: 'articles', label: t('subKnowledgeArticles'), href: `/${locale}?cat=knowledge&sub=Article` },
  ]
